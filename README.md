...
MOSA is a local-first creative asset library. It works alongside Codex, Cowart, the local Grok Build CLI, and an optional ChatGPT browser extension. Those tools create; MOSA keeps the context you need to find, understand, and continue the work.
...
| **ChatGPT in Chrome** | Optional web-captured images and message-scoped context through the local extension |
...
> **Project status:** this repository does not yet publish a packaged desktop installer. Do not treat a development checkout as a released app.
...
- ChatGPT web capture is optional and remains disabled until you configure both a local ingest Token and an approved extension origin. Its data stays on the configured local MOSA address.
