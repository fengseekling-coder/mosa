---
asset_id: keepItWooV2Style20
skill: punk-cover
style: french-minimal-ink-poster
ratio: 51:104
theme: keep-it-woo-v2-french-minimal-ink-poster
---

# 法式极简墨线海报 KEEP IT WOO cover prompt — V2
...
Create one single custom vertical cover for a physical 102 cm wide × 208 cm high panel. Preserve the exact portrait aspect ratio 51:104. Use exactly one selected visual style: 法式极简墨线海报 / french-minimal-ink-poster. The style must organize the subject, typography, material, space, and metaphor as one system.
...
Use 70-85 percent warm ivory negative space and one sparse hand-drawn black circle with broken ink edges. A few controlled ink marks spiral into a small open center; the circle stays conceptually whole and has no vertical rupture.
...
Let the handwritten-mechanical letterforms draw the circle itself. KEEP IT WOO follows one continuous ink trajectory; strokes become the circumference, and the two O letters are the portal rings. A tiny orderly pixel trace transitions from the final letter into the aperture.
...
Warm ivory paper, black ink, and at most one tiny muted blue or dark-red node.

Every material, texture, line, shadow, and color decision must visibly belong to 法式极简墨线海报.

## Negative Constraints

Avoid title set above illustration, generic sans caption, multiple metaphors, split circle, dense tech detail. Also avoid generic sci-fi doorway, generic HUD wallpaper, ordinary font layout, separate image and text layers, unrelated decoration, watermark, contact sheet, multiple options, and multiple final designs.
