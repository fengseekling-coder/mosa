---
asset_id: keepItWooV2DraftAStyle12
skill: punk-cover
style: black-white-gray-avant-geometry
ratio: 51:104
theme: keep-it-woo-v2-draft-a-black-white-gray-avant-geometry
---

# 黑白灰先锋几何 KEEP IT WOO cover prompt — V2
...
Create one single custom vertical cover for a physical 102 cm wide × 208 cm high panel. Preserve the exact portrait aspect ratio 51:104. Use exactly one selected visual style: 黑白灰先锋几何 / black-white-gray-avant-geometry. The style must organize the subject, typography, material, space, and metaphor as one system.
...
Compose one uninterrupted circle from cut planes, line fields, transparent layers, controlled fragments, and extreme black-white-gray tension. Internal rings rotate off-phase and reveal a small central aperture, but no breaks align into a vertical split.
...
Design custom geometric letterforms using the exact same arc radii, stroke weights, cut planes, and negative spaces as the circle. KEEP IT WOO interlocks with the circumference; some strokes substitute for arc segments, and both O letters are literal ring layers. Typography and geometry must be impossible to separate.
