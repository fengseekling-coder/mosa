---
asset_id: keepItWooV2Style18
skill: punk-cover
style: color-neo-constructivist-megastructure-poster
ratio: 51:104
theme: keep-it-woo-v2-color-neo-constructivist-megastructure-poster
---

# 彩色新构成主义巨构海报 KEEP IT WOO cover prompt — V2
...
Create one single custom vertical cover for a physical 102 cm wide × 208 cm high panel. Preserve the exact portrait aspect ratio 51:104. Use exactly one selected visual style: 彩色新构成主义巨构海报 / color-neo-constructivist-megastructure-poster. The style must organize the subject, typography, material, space, and metaphor as one system.
...
Crop one enormous but continuous circular megastructure so it occupies 60-75 percent of the frame. Giant arcs, wedges, tracks, and rays rotate around an open round core; directional force is tangential and radial, never a left-right collision or center split.
...
Turn KEEP IT WOO into load-bearing megastructure. Thick letter strokes become beams, wedges, and tracks that complete the circle; the two O letters are monumental nested rings and IT is a compressed directional joint. The title is the architecture, not text applied to it.
...
One dominant field, one concentrated explosive accent, one dark structural color, and one pale title color.

Every material, texture, line, shadow, and color decision must visibly belong to 彩色新构成主义巨构海报.

## Negative Constraints

Avoid opposing text panels, center seam, decorative geometry, normal headline, multiple focal points. Also avoid generic sci-fi doorway, generic HUD wallpaper, ordinary font layout, separate image and text layers, unrelated decoration, watermark, contact sheet, multiple options, and multiple final designs.
