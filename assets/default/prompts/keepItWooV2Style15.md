---
asset_id: keepItWooV2Style15
skill: punk-cover
style: retro-ink-dot-matrix-metaphor
ratio: 51:104
theme: keep-it-woo-v2-retro-ink-dot-matrix-metaphor
---

# 复古油墨点阵隐喻 KEEP IT WOO cover prompt — V2
...
Create one single custom vertical cover for a physical 102 cm wide × 208 cm high panel. Preserve the exact portrait aspect ratio 51:104. Use exactly one selected visual style: 复古油墨点阵隐喻 / retro-ink-dot-matrix-metaphor. The style must organize the subject, typography, material, space, and metaphor as one system.
...
On the fixed #DED9CF field, draw one small complete circular portal using only black dot-matrix and sparse letterpress marks. Dots increase toward a small open center and disperse outward, with ample untouched space.
...
Build KEEP IT WOO from the same dot matrix instead of setting ordinary type above the image. The phrase gradually transitions from mechanical letterpress strokes into the ring; the final two O letters are the actual concentric dot apertures. Preserve restrained scale and exact legibility.
...
Avoid separate top headline, oversized illustration, modern sans label, center split, extra text or color. Also avoid generic sci-fi doorway, generic HUD wallpaper, ordinary font layout, separate image and text layers, unrelated decoration, watermark, contact sheet, multiple options, and multiple final designs.
