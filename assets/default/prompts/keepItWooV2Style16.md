---
asset_id: keepItWooV2Style16
skill: punk-cover
style: black-midcentury-modernist-cover
ratio: 51:104
theme: keep-it-woo-v2-black-midcentury-modernist-cover
---

# 黑色复古现代主义封面 KEEP IT WOO cover prompt — V2
...
Create one single custom vertical cover for a physical 102 cm wide × 208 cm high panel. Preserve the exact portrait aspect ratio 51:104. Use exactly one selected visual style: 黑色复古现代主义封面 / black-midcentury-modernist-cover. The style must organize the subject, typography, material, space, and metaphor as one system.
...
Reduce the portal to one bold complete circular emblem made from black and ivory arcs with one accent wedge. A smaller round aperture opens inside through rotational overlap; the outer disk is never divided.
...
Construct KEEP IT WOO as mid-century geometric forms inside the emblem. Letter strokes double as black and ivory arc segments, while the two O letters become nested discs and the T crossbar becomes a tangential structural beam. No conventional headline area.
...
Black, warm ivory, and exactly one vivid accent such as burnt orange, cobalt, or vermilion.

Every material, texture, line, shadow, and color decision must visibly belong to 黑色复古现代主义封面.

## Negative Constraints

Avoid ordinary book-cover title block, multiple colors, 3D metal, central seam, split gate. Also avoid generic sci-fi doorway, generic HUD wallpaper, ordinary font layout, separate image and text layers, unrelated decoration, watermark, contact sheet, multiple options, and multiple final designs.
