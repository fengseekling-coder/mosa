---
asset_id: keepItWooV2Style17
skill: punk-cover
style: silver-foil-blue-minimal
ratio: 51:104
theme: keep-it-woo-v2-silver-foil-blue-minimal
---

# 银色锡纸蓝字 KEEP IT WOO cover prompt — V2
...
Create one single custom vertical cover for a physical 102 cm wide × 208 cm high panel. Preserve the exact portrait aspect ratio 51:104. Use exactly one selected visual style: 银色锡纸蓝字 / silver-foil-blue-minimal. The style must organize the subject, typography, material, space, and metaphor as one system.
...
Cover the canvas with real finely wrinkled silver foil. Draw one restrained continuous Klein-blue circular path with a small inner aperture and a subtle state-change loop; the line remains elegant and unbroken.
...
Draw KEEP IT WOO with the very same single blue line. The strokes flow continuously into the circular path; the W leads into two O loops that become the portal, and IT forms a small junction in the route. It must read as one line-based typographic mechanism, never as title plus icon.
...
Real cold silver foil and one uniform deep Klein blue only.

Every material, texture, line, shadow, and color decision must visibly belong to 银色锡纸蓝字.

## Negative Constraints

Avoid title separated above portal, large blue blocks, glow, 3D, split circle, separate line illustration. Also avoid generic sci-fi doorway, generic HUD wallpaper, ordinary font layout, separate image and text layers, unrelated decoration, watermark, contact sheet, multiple options, and multiple final designs.
