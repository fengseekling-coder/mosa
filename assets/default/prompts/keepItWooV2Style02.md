---
asset_id: keepItWooV2Style02
skill: punk-cover
style: semantic-minimal-translation
ratio: 51:104
theme: keep-it-woo-v2-semantic-minimal-translation
---

# 语义转译极简 KEEP IT WOO cover prompt — V2
...
Create one single custom vertical cover for a physical 102 cm wide × 208 cm high panel. Preserve the exact portrait aspect ratio 51:104. Use exactly one selected visual style: 语义转译极简 / semantic-minimal-translation. The style must organize the subject, typography, material, space, and metaphor as one system.
...
Reduce the whole idea to one exact visual sentence: the phrase itself becomes a circular opening mechanism. Keep only one large intact circle, the title, and a deep central aperture; no secondary scene or decorative interface.
...
Custom-build the phrase as one continuous circular word-object. KEEP forms the load-bearing upper-left circumference, IT becomes the locking notch and crossbar that releases the aperture, W becomes the lower directional hinge, and the two O letters become nested orbital openings. Letters and circle share strokes and negative space; removing the text would destroy the portal.
...
Warm white, black, graphite, and one restrained cobalt or vermilion activation node.

Every material, texture, line, shadow, and color decision must visibly belong to 语义转译极简.

## Negative Constraints

Avoid normal title over illustration, multiple objects, random labels, cheap gradients, center split. Also avoid generic sci-fi doorway, generic HUD wallpaper, ordinary font layout, separate image and text layers, unrelated decoration, watermark, contact sheet, multiple options, and multiple final designs.
