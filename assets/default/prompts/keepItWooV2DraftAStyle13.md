---
asset_id: keepItWooV2DraftAStyle13
skill: punk-cover
style: black-red-silhouette
ratio: 51:104
theme: keep-it-woo-v2-draft-a-black-red-silhouette
---

# 黑红剪影 KEEP IT WOO cover prompt — V2
...
Create one single custom vertical cover for a physical 102 cm wide × 208 cm high panel. Preserve the exact portrait aspect ratio 51:104. Use exactly one selected visual style: 黑红剪影 / black-red-silhouette. The style must organize the subject, typography, material, space, and metaphor as one system.
...
Use a pure-red field and one dominant black silhouette: a complete circular aperture with a solid unbroken outer silhouette and a white inner iris opening. Keep the metaphor immediate and flat.
...
Carve KEEP IT WOO out of the black circle as functional white negative space. Letter counters and gaps connect directly to the aperture; the two O letters become the circular iris and echo ring. The phrase should read around and through the silhouette, not sit above or below it. Use one deliberately asymmetric reading route: KEEP on the upper arc, IT once only near 3 o’clock, and WOO on the lower arc; the 9 o’clock position remains pure black mechanism. Never mirror or duplicate IT.
...
Pure red, solid black, and warm white only.

Every material, texture, line, shadow, and color decision must visibly belong to 黑红剪影.

## Negative Constraints

Avoid ordinary top or bottom caption, gradients, detailed UI, center split, two black door leaves. Also avoid generic sci-fi doorway, generic HUD wallpaper, ordinary font layout, separate image and text layers, unrelated decoration, watermark, contact sheet, multiple options, and multiple final designs.
