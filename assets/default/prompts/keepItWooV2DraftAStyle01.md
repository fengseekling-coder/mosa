---
asset_id: keepItWooV2DraftAStyle01
skill: punk-cover
style: black-white-minimal-concept
ratio: 51:104
theme: keep-it-woo-v2-draft-a-black-white-minimal-concept
---

# 黑白极简概念 KEEP IT WOO cover prompt — V2
...
Create one single custom vertical cover for a physical 102 cm wide × 208 cm high panel. Preserve the exact portrait aspect ratio 51:104. Use exactly one selected visual style: 黑白极简概念 / black-white-minimal-concept. The style must organize the subject, typography, material, space, and metaphor as one system.
...
A museum-grade black-to-silver tonal field containing one uninterrupted 360-degree topological ring sculpture. Thousands of luminous threads, contour paths, particles, wireframe membranes, and data points flow around the circle and funnel inward through a retracting iris aperture. The outer circumference remains whole.
...
Construct KEEP IT WOO from the same luminous threads and contour paths. The letters travel as a continuous typographic orbit through the ring layers; selected letter strokes replace arc segments and continue into particle paths. The two O counters become two active concentric apertures within the intact portal, while IT becomes a compact calibration key in the same orbit. The words are readable because line density increases inside each letterform, not because they sit on a label.
...
Black, charcoal, silver gray, and white, with one tiny cold activation point.

Every material, texture, line, shadow, and color decision must visibly belong to 黑白极简概念.

## Negative Constraints

Avoid flat generic HUD icons, smoke, colorful treatment, ordinary headline, title banner, center split. Also avoid generic sci-fi doorway, generic HUD wallpaper, ordinary font layout, separate image and text layers, unrelated decoration, watermark, contact sheet, multiple options, and multiple final designs.
