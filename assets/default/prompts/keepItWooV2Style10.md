---
asset_id: keepItWooV2Style10
skill: punk-cover
style: minimal-public-space-photography
ratio: 51:104
theme: keep-it-woo-v2-minimal-public-space-photography
---

# 极简公共空间摄影 KEEP IT WOO cover prompt — V2
...
Create one single custom vertical cover for a physical 102 cm wide × 208 cm high panel. Preserve the exact portrait aspect ratio 51:104. Use exactly one selected visual style: 极简公共空间摄影 / minimal-public-space-photography. The style must organize the subject, typography, material, space, and metaphor as one system.
...
Photograph a calm frontal public-space entrance whose defining form is one complete circular architectural aperture. The doorway opens through concentric rotating or telescoping rings, not through two sliding leaves. Soft natural light reveals a quiet passage beyond.
...
Integrate KEEP IT WOO as permanent architectural geometry: letters are cut from tile joints, cast into the circular lintel, and continued by floor and wall lines. The two O letters become real nested round openings within the architecture. Avoid signage panels; the typography must be inseparable from the construction.
...
Cream white, ice blue, pale wood, charcoal, and one tiny tomato-red marker.

Every material, texture, line, shadow, and color decision must visibly belong to 极简公共空间摄影.

## Negative Constraints

Avoid ordinary wall sign, title overlay, two doors, vertical seam, commercial showroom drama. Also avoid generic sci-fi doorway, generic HUD wallpaper, ordinary font layout, separate image and text layers, unrelated decoration, watermark, contact sheet, multiple options, and multiple final designs.
