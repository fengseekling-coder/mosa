---
asset_id: keepItWooV2Style19
skill: punk-cover
style: retro-japanese-sci-fi-anime-cover
ratio: 51:104
theme: keep-it-woo-v2-retro-japanese-sci-fi-anime-cover
---

# 复古日本科幻动画 KEEP IT WOO cover prompt — V2
...
Create one single custom vertical cover for a physical 102 cm wide × 208 cm high panel. Preserve the exact portrait aspect ratio 51:104. Use exactly one selected visual style: 复古日本科幻动画 / retro-japanese-sci-fi-anime-cover. The style must organize the subject, typography, material, space, and metaphor as one system.
...
Create one 1990s Japanese sci-fi cel-animation activation frame: a complete circular mechanism whose internal iris plates rotate and retract into a brilliant round core. Use hard-edged cel shadows, sharp hand-drawn lines, exaggerated depth, and one active transformation.
...
Design KEEP IT WOO as a custom title-card mechanism within the moving ring. Letter strokes become animated panel edges, action lines, and radial energy paths; the two O letters are the active apertures. The phrase curves through the mechanism with dramatic scale changes but remains exact and readable.
...
One main background, one secondary color, and one small accent selected from deep purple, fluorescent green, deep blue-black, warning yellow, bright violet, orange, black, and cream.

Every material, texture, line, shadow, and color decision must visibly belong to 复古日本科幻动画.

## Negative Constraints

Avoid ordinary sans-serif caption, static door, split halves, characters or copied mecha, modern cyberpunk UI. Also avoid generic sci-fi doorway, generic HUD wallpaper, ordinary font layout, separate image and text layers, unrelated decoration, watermark, contact sheet, multiple options, and multiple final designs.
