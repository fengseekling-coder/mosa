---
asset_id: keepItWooV2Style21
skill: punk-cover
style: brand-collaboration-connection
ratio: 51:104
theme: keep-it-woo-v2-brand-collaboration-connection
---

# 品牌协同连接 KEEP IT WOO cover prompt — V2
...
Create one single custom vertical cover for a physical 102 cm wide × 208 cm high panel. Preserve the exact portrait aspect ratio 51:104. Use exactly one selected visual style: 品牌协同连接 / brand-collaboration-connection. The style must organize the subject, typography, material, space, and metaphor as one system.
...
Create one clean enterprise-grade circular connection system on a cool white field. Two softly modeled typographic identity modules orbit the same unbroken portal track, connected through a small central state node without forming opposing halves or a divider.
...
KEEP and WOO are not labels under icons: each word is sculpted into a rounded identity module whose inner letter counters feed the shared circular track. IT is the compact integration node, while the two O letters become nested portal loops. Connector, type, and aperture form one continuous mechanism.
...
Cool white, graphite, one restrained blue accent and one restrained violet or coral accent unified through the circular connector.

Every material, texture, line, shadow, and color decision must visibly belong to 品牌协同连接.

## Negative Constraints

Avoid left icon versus right icon split, pill-shaped title labels, central divider, extra logos, workflow diagram. Also avoid generic sci-fi doorway, generic HUD wallpaper, ordinary font layout, separate image and text layers, unrelated decoration, watermark, contact sheet, multiple options, and multiple final designs.
