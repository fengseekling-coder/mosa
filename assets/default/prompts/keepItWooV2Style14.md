---
asset_id: keepItWooV2Style14
skill: punk-cover
style: avant-retro-architecture-poster
ratio: 51:104
theme: keep-it-woo-v2-avant-retro-architecture-poster
---

# 先锋复古建筑海报 KEEP IT WOO cover prompt — V2
...
Create one single custom vertical cover for a physical 102 cm wide × 208 cm high panel. Preserve the exact portrait aspect ratio 51:104. Use exactly one selected visual style: 先锋复古建筑海报 / avant-retro-architecture-poster. The style must organize the subject, typography, material, space, and metaphor as one system.
...
Design one sole monumental circular entrance pavilion in mid-century architectural-poster language. It is a complete ring building with an open central passage created by nested round colonnades or a recessed aperture, never by parted wings.
...
Make KEEP IT WOO structural façade architecture: letter strokes are columns, beams, stairs, and colored massing within the circular building. The O letters are inhabited round courts or arches, while the other letters follow the building curvature. No applied façade sign is allowed.
...
One pure background, two building colors, one deep structural shadow, and one small highlight.

Every material, texture, line, shadow, and color decision must visibly belong to 先锋复古建筑海报.

## Negative Constraints

Avoid signage pasted on façade, two building wings, vertical separation, photorealism, decorative sun disks. Also avoid generic sci-fi doorway, generic HUD wallpaper, ordinary font layout, separate image and text layers, unrelated decoration, watermark, contact sheet, multiple options, and multiple final designs.
