---
asset_id: keepItWooV2Style11
skill: punk-cover
style: business-magazine-front-page
ratio: 51:104
theme: keep-it-woo-v2-business-magazine-front-page
---

# 商业杂志头版 KEEP IT WOO cover prompt — V2
...
Create one single custom vertical cover for a physical 102 cm wide × 208 cm high panel. Preserve the exact portrait aspect ratio 51:104. Use exactly one selected visual style: 商业杂志头版 / business-magazine-front-page. The style must organize the subject, typography, material, space, and metaphor as one system.
...
Use one complete circular market-system metaphor: a bold flywheel or access aperture whose internal segments rotate and unlock while its outer boundary stays continuous. Maintain sharp editorial hierarchy with only sparse supporting marks.
...
Reconstruct KEEP IT WOO as the business mechanism: letter stems become growth paths, risk boundaries, and system nodes; the phrase follows the circular reading route. The two O letters are nested flywheels and IT is the decision trigger. Do not place the title in a banner, masthead, or separate block.
...
High-contrast black, white, graphite, and one assertive signal red, cobalt, or acid yellow.

Every material, texture, line, shadow, and color decision must visibly belong to 商业杂志头版.

## Negative Constraints

Avoid fake masthead, title panel, stock market screen, dense columns, divided door. Also avoid generic sci-fi doorway, generic HUD wallpaper, ordinary font layout, separate image and text layers, unrelated decoration, watermark, contact sheet, multiple options, and multiple final designs.
