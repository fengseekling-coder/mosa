---
asset_id: keepItWooV2DraftAStyle08
skill: punk-cover
style: research-journal-concept
ratio: 51:104
theme: keep-it-woo-v2-draft-a-research-journal-concept
---

# 科研期刊概念 KEEP IT WOO cover prompt — V2
...
Create one single custom vertical cover for a physical 102 cm wide × 208 cm high panel. Preserve the exact portrait aspect ratio 51:104. Use exactly one selected visual style: 科研期刊概念 / research-journal-concept. The style must organize the subject, typography, material, space, and metaphor as one system.
...
Present one original advanced optical or metamaterial apparatus: a complete annular structure with microscopic layers, interference edges, and a round iris aperture retracting in depth. It should imply mechanism like a premium research-journal concept cover, never a generic sci-fi door.
...
Etch KEEP IT WOO into the functional annular layers so letter strokes are fabricated channels, waveguides, or material boundaries. The two O counters are actual optical apertures with measurable depth; IT is a calibration junction. Text and apparatus share identical material, thickness, and optical behavior. Place KEEP on the upper arc, IT once only near 3 o’clock, and WOO on the lower arc; the 9 o’clock side contains scientific structure only. Never mirror or duplicate IT.
...
Scientific black, silver-white structural light, and restrained cyan-violet interference only.

Every material, texture, line, shadow, and color decision must visibly belong to 科研期刊概念.

## Negative Constraints

Avoid journal masthead, unrelated DNA or chips, title plaque, twin panels, central division. Also avoid generic sci-fi doorway, generic HUD wallpaper, ordinary font layout, separate image and text layers, unrelated decoration, watermark, contact sheet, multiple options, and multiple final designs.
