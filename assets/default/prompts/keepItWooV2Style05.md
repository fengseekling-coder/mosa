---
asset_id: keepItWooV2Style05
skill: punk-cover
style: giant-perspective-chinese-title
ratio: 51:104
theme: keep-it-woo-v2-giant-perspective-chinese-title
---

# 巨型透视中文标题 KEEP IT WOO cover prompt — V2
...
Create one single custom vertical cover for a physical 102 cm wide × 208 cm high panel. Preserve the exact portrait aspect ratio 51:104. Use exactly one selected visual style: 巨型透视中文标题 / giant-perspective-chinese-title. The style must organize the subject, typography, material, space, and metaphor as one system.
...
Apply the giant-perspective method to the supplied English phrase. One intact circular portal dominates the vanishing point; its internal iris opens in depth while the outer ring remains continuous. Perspective, compression, speed lines, and hard shadow create event-poster force.
...
Turn KEEP IT WOO into monumental perspective architecture that coils through and around the complete portal. Letter stems become radial walls and tracks, crossbars align with ring tangents, and the two O letters are huge nested tunnel apertures. The phrase must be read as one continuous spatial construction, never as two opposing walls or separate captions.
...
Black, cream white, hard silver, and one intense red or electric orange accent.

Every material, texture, line, shadow, and color decision must visibly belong to 巨型透视中文标题.

## Negative Constraints

Avoid ordinary flat title, left-right word split, door leaves, center gap, illegible perspective distortion. Also avoid generic sci-fi doorway, generic HUD wallpaper, ordinary font layout, separate image and text layers, unrelated decoration, watermark, contact sheet, multiple options, and multiple final designs.
