---
asset_id: keepItWooV2Style06
skill: punk-cover
style: brick-world
ratio: 51:104
theme: keep-it-woo-v2-brick-world
---

# 积木世界 KEEP IT WOO cover prompt — V2
...
Create one single custom vertical cover for a physical 102 cm wide × 208 cm high panel. Preserve the exact portrait aspect ratio 51:104. Use exactly one selected visual style: 积木世界 / brick-world. The style must organize the subject, typography, material, space, and metaphor as one system.
...
Stage a precise miniature brick-built circular machine. A continuous outer ring of studs, plates, gears, and connectors contains an inner radial iris that retracts into the circumference; assembly logic remains visible and orderly.
...
Construct each letter from functional brick modules that also serve as ring segments, gear teeth, and locking connectors. KEEP IT WOO follows the machine circumference; the O letters are working annular gear assemblies and IT forms the release latch. No separate brick nameplate is allowed.
...
Black, white, cool gray, cobalt, and one small yellow or red construction accent.

Every material, texture, line, shadow, and color decision must visibly belong to 积木世界.

## Negative Constraints

Avoid loose bricks, brand logos, rectangular title plates, childish clutter, split door. Also avoid generic sci-fi doorway, generic HUD wallpaper, ordinary font layout, separate image and text layers, unrelated decoration, watermark, contact sheet, multiple options, and multiple final designs.
