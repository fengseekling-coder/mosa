---
asset_id: keepItWooV2Style03
skill: punk-cover
style: retro-torn-collage
ratio: 51:104
theme: keep-it-woo-v2-retro-torn-collage
---

# 复古手撕拼贴 KEEP IT WOO cover prompt — V2
...
Create one single custom vertical cover for a physical 102 cm wide × 208 cm high panel. Preserve the exact portrait aspect ratio 51:104. Use exactly one selected visual style: 复古手撕拼贴 / retro-torn-collage. The style must organize the subject, typography, material, space, and metaphor as one system.
...
Build one complete circular portal from concentric torn newspaper rings, magazine fragments, photocopy grain, halftone dots, tape, folds, and real paper shadows. The portal opens by peeling inner paper layers backward around a circular aperture while the external ring stays continuous.
...
Cut every letter from the same concentric paper system: letter edges coincide with torn arcs, ink registration lines pass through strokes, and paper layers visible inside counters continue into the ring. KEEP IT WOO follows one designed orbit rather than sitting on a strip. The two O letters are punched paper apertures that become functional portal rings.
...
Avoid title strip across the middle, random scrap pile, clean digital cards, twin door panels, center split. Also avoid generic sci-fi doorway, generic HUD wallpaper, ordinary font layout, separate image and text layers, unrelated decoration, watermark, contact sheet, multiple options, and multiple final designs.
