---
asset_id: keepItWooV2Style07
skill: punk-cover
style: consulting-report-visual
ratio: 51:104
theme: keep-it-woo-v2-consulting-report-visual
---

# 咨询报告视觉 KEEP IT WOO cover prompt — V2
...
Create one single custom vertical cover for a physical 102 cm wide × 208 cm high panel. Preserve the exact portrait aspect ratio 51:104. Use exactly one selected visual style: 咨询报告视觉 / consulting-report-visual. The style must organize the subject, typography, material, space, and metaphor as one system.
...
Abstract the portal as one complete strategic flywheel with concentric value paths, sparse nodes, precise matrix boundaries, and an inner state-change aperture. Rotation and radial convergence communicate opening without a dividing line.
...
Make KEEP IT WOO part of the framework itself: letter stems are path boundaries, crossbars are matrix axes, and counters are functional nodes. The phrase follows one flywheel reading path; the O letters become two nested system loops and IT becomes the central decision gate. No headline box or report-title strip.
...
White or deep navy-gray, black, silver, and one restrained cobalt or red-orange accent.

Every material, texture, line, shadow, and color decision must visibly belong to 咨询报告视觉.

## Negative Constraints

Avoid fake data, dense charts, PPT title bar, split panels, center seam. Also avoid generic sci-fi doorway, generic HUD wallpaper, ordinary font layout, separate image and text layers, unrelated decoration, watermark, contact sheet, multiple options, and multiple final designs.
