...
test("desktop publishes startup handoff before opening the runtime and releases it after ownership resolves", async () => {
  ...
  assert.ok(source.includes('preferOwnedRuntime: process.platform === "darwin" && app.isPackaged && Boolean(desktopStartupHandoffLease)'), "packaged macOS prefers owning the primary runtime during handoff");
